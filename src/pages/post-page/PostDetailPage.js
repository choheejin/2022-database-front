        ...
        <div className="w-full flex justify-center items-center">
            <div className="w-[60%] flex flex-col gap-8">
                ...
                <div className="w-full flex justify-center mb-16 cursor-pointer">
                    <div onClick={() => {setPressLike(!pressLike); console.log(pressLike)}}
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex border-b border-gray-200 gap-4 pb-4">
                        <img className="w-28 h-28 object-center object-cover rounded-full" src="../../images/sample22.jpeg"/>
                        <div className="flex font-bold items-center text-xl">작성자</div>
                    </div>
