...
function Navigation(props) {
    ...
    return (
        <div className={`${IsScroll === 1 ? 'sticky top-0 z-50 bg-white drop-shadow' : ''} w-full flex justify-center mb-2`}>
            <div className="flex justify-between items-center w-[75%] py-4 sm:px-2">
                <a href={process.env.REACT_APP_PUBLIC_URL+"/"} className="flex items-center gap-4">
                    ...
                    <div className="sm:flex cursor-pointer font-bold text-gray-700 hidden text-3xl font-cute">고뮤니티</div>
                </a>
                <div>
                    {
                        User !== ''?
